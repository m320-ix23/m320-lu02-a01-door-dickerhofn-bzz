class Door:
    ...
    Das verriegeln selber delegiert die Türe an ein Objekt vom Typ
    Door_lock (Türschloss).
    """

    # Mit dem Keyword def wird eine Funktion bzw. eben ein
    # Konstruktor deklariert.
    # Der Konstruktor trägt IMMER den Namen __init__ und weist als ersten
    # Parameter den Wert self auf.
    # Danach folgen die Übergabeparameter, deren Werte dann den
...
class DoorLock:
    """
    dummy Klasse, damit in der Klasse Tuere kein Fehler auf tri tt
    """
